...
复用组织 Secrets：MYSQL_HOST、MYSQL_PORT、ALIYUN_ACR_REGISTRY、ALIYUN_ACR_NAMESPACE、ALIYUN_ACR_USERNAME、ALIYUN_ACR_PASSWORD、SVRA_HOST、SVRA_USERNAME、SVRA_SSH_PORT，以及优先使用的 SVR_MINI_SSH_KEY（缺失时用 SVRA_SSH_KEY）。serverA 地址、用户、端口支持同名仓库变量覆盖。
