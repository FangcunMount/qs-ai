...
class FlowManagementStub:
    ...
    def __init__(self, channel):
        ...
        self.GetSolution = channel.unary_unary(
                '/qsai.workflow.v1.FlowManagement/GetSolution',
                request_serializer=workflow__pb2.FlowQuery.SerializeToString,
                response_deserializer=workflow__pb2.SolutionResponse.FromString,
                _registered_method=True)
        self.GetPublication = channel.unary_unary(
                '/qsai.workflow.v1.FlowManagement/GetPublication',
                request_serializer=workflow__pb2.FlowQuery.SerializeToString,
                response_deserializer=workflow__pb2.SolutionResponse.FromString,
                _registered_method=True)


class FlowManagementServicer:
    """Missing associated documentation comment in .proto file."""
...
def add_FlowManagementServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSolution': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSolution,
                    request_deserializer=workflow__pb2.FlowQuery.FromString,
                    response_serializer=workflow__pb2.SolutionResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'qsai.workflow.v1.FlowManagement', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('qsai.workflow.v1.FlowManagement', rpc_method_handlers)
...
class FlowManagement:
    ...
    def GetSolution(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/qsai.workflow.v1.FlowManagement/GetSolution',
            workflow__pb2.FlowQuery.SerializeToString,
            workflow__pb2.SolutionResponse.FromString,
            options,
            channel_credentials,
            insecure,
