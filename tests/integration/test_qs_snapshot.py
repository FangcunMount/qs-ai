...
from qs_ai.application.interpretation.ports import AccessDenied, WorkflowResult
...
async def test_snapshot_executes_without_authorization_backend_and_rejects_changed_replay(kit):  # noqa: F811
    source = UnconfiguredEvidenceSource()
